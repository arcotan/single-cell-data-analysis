# Filtering Tabula Muris heart and aorta
...
pbmc[["percent.mt"]] <- PercentageFeatureSet(pbmc, pattern = "^Mt") # 2% in this plot
# mouses have Mt, humans MT, check on enrichr if mithocondrial
...
pbmc <- subset(pbmc, subset = nFeature_RNA > 0 & nFeature_RNA < 5000 & percent.mt < 2) # 5000 as reference
