---
title: Clustering and differential expression analysis of PBMC3 using Seurat
---
...
```{r}
pbmc <- FindNeighbors(pbmc, dims = 1:11) # chosen based on elbow plot above
pbmc <- FindClusters(pbmc, resolution = 0.90)
```
