...
```{r}
dataset_name = 'E175'  # VARIABLE
DATASET_PATH = "../../dataset/"
DATA_DIR = paste(DATASET_PATH, dataset_name,'/', dataset_name, '.csv' , sep='')
LABEL_DIR = paste(DATASET_PATH, dataset_name, sep='')
...
```{r}
csv_data <- read.csv(DATA_DIR, header = TRUE, row.names = 1)
matrix_data <- as.matrix(csv_data)
cds <- new_cell_data_set(matrix_data)
```
