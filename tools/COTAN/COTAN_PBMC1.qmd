...
c(mergedClusters, mergedCoexDF) %<-%
  mergeUniformCellsClusters(PBMC1_celltypist, clusters = splitClusters,
                            GDIThreshold = 1.4, # to tune (binary search is probably not feasible...)
                            cores = 13,
                            saveObj = TRUE, outDir = OUT_DEFAULT_DIR)

PBMC1_celltypist <- addClusterization(PBMC1_celltypist, clName = "merged",
                             clusters = mergedClusters,
                             coexDF = mergedCoexDF,
                             override = TRUE)
```
...
PBMC1_protein <- addClusterization(PBMC1_protein, clName = "merged",
                             clusters = mergedClusters,
                             coexDF = mergedCoexDF,
                             override = TRUE)
```
