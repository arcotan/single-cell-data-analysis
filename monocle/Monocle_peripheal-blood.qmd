...
```{r}
cds <- cluster_cells(cds, resolution=0.22, reduction_method = "PCA")
...
```
```{r}
# ***** TODO Plot in ClusteringAnalysis *****
# plot_de(exprs(cds), marker_test_res, "gene_id", "cell_group", label_df, "cell", "computed_id", OUT_RES_DIR)
